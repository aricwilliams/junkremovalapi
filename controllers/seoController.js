 ...
 * @param {number} cellMiles - Cell size in miles
...
function calculateDistance(coord1, coord2) {
  const R = 3958.761; // Earth's radius in miles
...
// Removed geocode and grid endpoints - only need the main analyze endpoint
 ...
 * It handles: geocoding, grid generation, and SerpApi ranking analysis
 */
